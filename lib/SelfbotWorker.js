...
let odaily = "owo daily", opray = "owo pray", oinv = "owo inv", olb = "owo lb all", ouse = "owo use", ordinary = ["whunt", "w battle", "w hunt", "wbattle", "owo hunt" , "owo battle"], oother = ["owo run", "owo pup", "owo piku"], ohb = "owo huntbot"
